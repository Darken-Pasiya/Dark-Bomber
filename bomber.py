...
W = '\033[0m'
# The Credit For This Code Goes To Darken Pasiya https://github.com/Darken-Pasiya/Dark-Bomber
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("             This Bomber Is Maintained By Darken Pasiya !!    ")
        print("==================================================================")
        try:
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/Darken-Pasiya/Dark-Bomber/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
try:
    ...
    os.system("figlet -f mono12 Error | lolcat")
    print("")
    print('\033[47;4;31m' "\tPlease Connect To Internet...\n"'\033[0m')
    print("")
    print("")
    print('\033[40;4;37m'"wait for auto run again..."'\033[0m')
    os.system("sleep 5.0")
    print("")
    print("")
    os.system("figlet -f mono12   3 | lolcat")
    os.system("sleep 1")
    os.system("figlet -f mono12   2 | lolcat")
    os.system("sleep 1")
    os.system("figlet -f mono12   1 | lolcat")
    os.system("sleep 0.2")
    os.system("clear")
    os.system("cd -")
    os.system("bash Dark-Bomb.sh")
print('\tChecking For Updates...')
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/Darken-Pasiya/Dark-Bomber/master/.version").read().decode('utf-8')
verl = ''
try:
...
if ver != verl:
    ...
    print('\tUpdating Dark-Bomber...')
    update()
print("Congratulation")
print("Your Version is Up-To-Date")
print('\n\n\t\t\tBeginning Dark-Bomber...\n\n')
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/Darken-Pasiya/Dark-Bomber/master/.notify").read().decode('utf-8')
...
while True:
    pn = ""
    cc = input('\033[32m' "\tEnter Your Country Code (Without +) : ")
    if '+' in cc:
        tc = list(cc)
        tc.remove('+')
        cc = ''.join(tc)
        cc = cc.strip()
    pn = input('\033[32m' "\tEnter Target Number: +" + cc + " ")
    pn = remsp(pn)
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\tDark-Bomber Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
